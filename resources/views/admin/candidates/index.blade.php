                    ...
                    <form action="{{route('candidates.store')}}">
                        <div class="modal-body">
                            <div class="row g-2">
                                ...
                                <div class="mb-3 col-md-6">
                                    <label for="inputPassword4" class="form-label">Nama Wakil</label>
                                    <input type="text" class="form-control" id="vice_name" name="vice_name"
                                           required
    ...
    <script>
        $(document).ready(function () {
            ...
            $(document).on('click', '.delete', function () {
                ...
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        let url = "{{ route('candidates.destroy', ':id') }}";
            ...
            $(document).on('click', '.edit', function () {
                ...
                //set data to form
                $('#staticBackdropLabel').text('Edit Kandidat');
                $('form').attr('action', `candidates/${data.id}`);
            ...
            $(document).on('click', '#create', function () {
                $('#staticBackdropLabel').text('Tambah Kandidat');
                $('form').attr('action', `candidates`);
