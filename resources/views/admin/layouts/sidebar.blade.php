...
<div class="leftside-menu">
    ...
    <a href="{{route('dashboard')}}" class="logo logo-light">
        <span class="logo-lg">
            <img src="{{asset('images')}}/frontend/logo.png" alt="logo">
        </span>
        <span class="logo-sm">
            <img src="{{asset('images')}}/frontend/logo.png" alt="small logo">
        </span>
    </a>
    ...
    <a href="{{route('dashboard')}}" class="logo logo-dark">
        <span class="logo-lg">
            <img src="{{asset('images')}}/frontend/logo.png" alt="dark logo">
        </span>
        <span class="logo-sm">
            <img src="{{asset('images')}}/frontend/logo.png" alt="small logo">
        </span>
