...
<script>
    formAjax({}, "{{route('get.district')}}?city_id=3202", 'get',).then(function (response) {
        ...
        $('#subdistrict').change(function () {
            ...
            //get data suara Kota
            formAjax({}, "{{route('realCount.data')}}?getKecamatan=" + district_id, 'get',).then(function (response) {
        ...
        $('#village').change(function () {
            ...
            $('#tps').html('');
            formAjax({}, "{{route('tps.data')}}?getTps=1&notnull=1&village_id=" + village_id + "&district_id=" + district_id, 'get',).then(function (response) {
            ...
            formAjax({}, "{{route('realCount.data')}}?getKelurahan=" + village_id, 'get',).then(function (response) {
        ...
        //get data suara Kota
        formAjax({}, "{{route('realCount.data')}}?getKota=1", 'get',).then(function (response) {
            var seriesData = response.data.series;
            var labelsData = response.data.labels;
            var options = {
                series: seriesData,
